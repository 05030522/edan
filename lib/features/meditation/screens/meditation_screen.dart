...
class _MeditationScreenState extends ConsumerState<MeditationScreen>
  ...
  void initState() {
    ...
    if (matthewContents.isNotEmpty) {
      ...
      _todayContent =
          _meditationContents[dayOfYear % _meditationContents.length];
    }
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
            ...
            child: Row(
              children: [
                ...
                TextButton(
                  ...
                  child: const Text('다시 읽기', style: TextStyle(fontSize: 12)),
                ),
              ],
            ),
          ),
          ...
          const SizedBox(height: AppTheme.spacingSM),
          Text('짧은 한 줄이라도 좋아요', style: AppTypography.bodyMedium(subTextColor)),
          const SizedBox(height: AppTheme.spacingXL),
