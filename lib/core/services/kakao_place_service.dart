...
class KakaoPlaceService {
  ...
  static final List<KakaoChurchResult> _churches = [
    ...
    // ─── 추가 교회 (101~200) ───
    // 서울 추가
    const KakaoChurchResult(id: '101', name: '영동제일교회', address: '서울 강남구 대치동', roadAddress: '서울 강남구 삼성로 51길 7'),
    const KakaoChurchResult(id: '102', name: '동대문중앙교회', address: '서울 동대문구 전농동', roadAddress: '서울 동대문구 전농로 36'),
    const KakaoChurchResult(id: '103', name: '성내교회', address: '서울 강동구 성내동', roadAddress: '서울 강동구 성내로 25'),
    const KakaoChurchResult(id: '104', name: '삼성교회', address: '서울 강남구 삼성동', roadAddress: '서울 강남구 봉은사로 608'),
    const KakaoChurchResult(id: '105', name: '동작교회', address: '서울 동작구 상도동', roadAddress: '서울 동작구 상도로 272'),
    const KakaoChurchResult(id: '106', name: '도봉교회', address: '서울 도봉구 도봉동', roadAddress: '서울 도봉구 도봉로 164길 11'),
    const KakaoChurchResult(id: '107', name: '성락교회', address: '서울 구로구 오류동', roadAddress: '서울 구로구 경인로 20길 28'),
    const KakaoChurchResult(id: '108', name: '금란교회', address: '서울 구로구 구로동', roadAddress: '서울 구로구 구로중앙로 288'),
    const KakaoChurchResult(id: '109', name: '중앙성결교회', address: '서울 용산구 한강로', roadAddress: '서울 용산구 한강대로 92'),
    const KakaoChurchResult(id: '110', name: '청파교회', address: '서울 용산구 청파동', roadAddress: '서울 용산구 백범로 67'),
    const KakaoChurchResult(id: '111', name: '서초중앙교회', address: '서울 서초구 방배동', roadAddress: '서울 서초구 방배로 226'),
    const KakaoChurchResult(id: '112', name: '안암교회', address: '서울 성북구 안암동', roadAddress: '서울 성북구 고려대로 104'),
    const KakaoChurchResult(id: '113', name: '미아교회', address: '서울 강북구 미아동', roadAddress: '서울 강북구 도봉로 148'),
    const KakaoChurchResult(id: '114', name: '노량진교회', address: '서울 동작구 노량진동', roadAddress: '서울 동작구 만양로 14길 12'),
    const KakaoChurchResult(id: '115', name: '대방교회', address: '서울 동작구 대방동', roadAddress: '서울 동작구 여의대방로 175'),
    // 경기도 추가
    const KakaoChurchResult(id: '116', name: '분당중앙교회', address: '경기 성남시 분당구 서현동', roadAddress: '경기 성남시 분당구 분당로 53번길 11'),
    const KakaoChurchResult(id: '117', name: '판교교회', address: '경기 성남시 분당구 판교동', roadAddress: '경기 성남시 분당구 판교로 228번길 15'),
    const KakaoChurchResult(id: '118', name: '수지교회', address: '경기 용인시 수지구', roadAddress: '경기 용인시 수지구 풍덕천로 120'),
    const KakaoChurchResult(id: '119', name: '기흥교회', address: '경기 용인시 기흥구', roadAddress: '경기 용인시 기흥구 구갈로 60'),
    const KakaoChurchResult(id: '120', name: '광교교회', address: '경기 수원시 영통구', roadAddress: '경기 수원시 영통구 광교로 145'),
    const KakaoChurchResult(id: '121', name: '영통교회', address: '경기 수원시 영통구', roadAddress: '경기 수원시 영통구 영통로 200'),
    const KakaoChurchResult(id: '122', name: '안산중앙교회', address: '경기 안산시 단원구', roadAddress: '경기 안산시 단원구 광덕대로 253'),
    const KakaoChurchResult(id: '123', name: '시화교회', address: '경기 시흥시 정왕동', roadAddress: '경기 시흥시 서해안로 277'),
    const KakaoChurchResult(id: '124', name: '오산교회', address: '경기 오산시 오산동', roadAddress: '경기 오산시 경기대로 130'),
    const KakaoChurchResult(id: '125', name: '이천교회', address: '경기 이천시 중리동', roadAddress: '경기 이천시 이섭대천로 1230'),
    const KakaoChurchResult(id: '126', name: '양주교회', address: '경기 양주시 양주동', roadAddress: '경기 양주시 부흥로 1522'),
    const KakaoChurchResult(id: '127', name: '포천교회', address: '경기 포천시 신읍동', roadAddress: '경기 포천시 중앙로 69'),
    const KakaoChurchResult(id: '128', name: '하남미사교회', address: '경기 하남시 미사동', roadAddress: '경기 하남시 미사강변대로 195'),
    const KakaoChurchResult(id: '129', name: '위례교회', address: '경기 성남시 수정구 창곡동', roadAddress: '경기 성남시 수정구 위례광장로 20'),
    const KakaoChurchResult(id: '130', name: '동탄중앙교회', address: '경기 화성시 동탄', roadAddress: '경기 화성시 동탄반석로 204'),
    // 인천 추가
    const KakaoChurchResult(id: '131', name: '인천중앙교회', address: '인천 남동구 구월동', roadAddress: '인천 남동구 인하로 489'),
    const KakaoChurchResult(id: '132', name: '계양교회', address: '인천 계양구 계산동', roadAddress: '인천 계양구 계양산로 98'),
    const KakaoChurchResult(id: '133', name: '청라교회', address: '인천 서구 청라동', roadAddress: '인천 서구 청라에메랄드로 55'),
    const KakaoChurchResult(id: '134', name: '검단교회', address: '인천 서구 검단동', roadAddress: '인천 서구 검단로 549'),
    // 부산 추가
    const KakaoChurchResult(id: '135', name: '서면교회', address: '부산 부산진구 부전동', roadAddress: '부산 부산진구 서전로 37'),
    const KakaoChurchResult(id: '136', name: '사직교회', address: '부산 동래구 사직동', roadAddress: '부산 동래구 사직북로 31'),
    const KakaoChurchResult(id: '137', name: '기장교회', address: '부산 기장군 기장읍', roadAddress: '부산 기장군 기장읍 기장대로 380'),
    const KakaoChurchResult(id: '138', name: '덕천교회', address: '부산 북구 덕천동', roadAddress: '부산 북구 금곡대로 232'),
    const KakaoChurchResult(id: '139', name: '금정교회', address: '부산 금정구 부곡동', roadAddress: '부산 금정구 금정로 65'),
    const KakaoChurchResult(id: '140', name: '센텀교회', address: '부산 해운대구 우동', roadAddress: '부산 해운대구 센텀중앙로 78'),
    // 대구 추가
    const KakaoChurchResult(id: '141', name: '달서교회', address: '대구 달서구 월성동', roadAddress: '대구 달서구 달구벌대로 1434'),
    const KakaoChurchResult(id: '142', name: '남산교회', address: '대구 중구 남산동', roadAddress: '대구 중구 달구벌대로 2077'),
    const KakaoChurchResult(id: '143', name: '북대구교회', address: '대구 북구 산격동', roadAddress: '대구 북구 대학로 15길 14'),
    const KakaoChurchResult(id: '144', name: '칠곡교회', address: '대구 북구 칠곡동', roadAddress: '대구 북구 칠곡중앙대로 300'),
    // 대전 추가
    const KakaoChurchResult(id: '145', name: '둔산교회', address: '대전 서구 둔산동', roadAddress: '대전 서구 둔산로 31'),
    const KakaoChurchResult(id: '146', name: '유성교회', address: '대전 유성구 장대동', roadAddress: '대전 유성구 유성대로 767'),
    const KakaoChurchResult(id: '147', name: '대덕교회', address: '대전 대덕구 오정동', roadAddress: '대전 대덕구 한밭대로 1120'),
    // 광주 추가
    const KakaoChurchResult(id: '148', name: '광주서문교회', address: '광주 서구 치평동', roadAddress: '광주 서구 상무중앙로 44'),
    const KakaoChurchResult(id: '149', name: '남광주교회', address: '광주 남구 봉선동', roadAddress: '광주 남구 봉선로 104'),
    const KakaoChurchResult(id: '150', name: '하남교회', address: '광주 광산구 하남동', roadAddress: '광주 광산구 하남대로 300'),
    // 충청도 추가
    const KakaoChurchResult(id: '151', name: '아산교회', address: '충남 아산시 온천동', roadAddress: '충남 아산시 온천대로 1467'),
    const KakaoChurchResult(id: '152', name: '당진교회', address: '충남 당진시 읍내동', roadAddress: '충남 당진시 당진중앙2로 86'),
    const KakaoChurchResult(id: '153', name: '서산교회', address: '충남 서산시 동문동', roadAddress: '충남 서산시 중앙로 11'),
    const KakaoChurchResult(id: '154', name: '홍성교회', address: '충남 홍성군 홍성읍', roadAddress: '충남 홍성군 홍성읍 충서로 23'),
    const KakaoChurchResult(id: '155', name: '제천교회', address: '충북 제천시 화산동', roadAddress: '충북 제천시 의림대로 220'),
    const KakaoChurchResult(id: '156', name: '옥천교회', address: '충북 옥천군 옥천읍', roadAddress: '충북 옥천군 옥천읍 중앙로 40'),
    // 전라도 추가
    const KakaoChurchResult(id: '157', name: '익산교회', address: '전북 익산시 영등동', roadAddress: '전북 익산시 익산대로 168'),
    const KakaoChurchResult(id: '158', name: '남원교회', address: '전북 남원시 도통동', roadAddress: '전북 남원시 충정로 96'),
    const KakaoChurchResult(id: '159', name: '정읍교회', address: '전북 정읍시 수성동', roadAddress: '전북 정읍시 충정로 73'),
    const KakaoChurchResult(id: '160', name: '광양교회', address: '전남 광양시 광양읍', roadAddress: '전남 광양시 광양읍 순광로 60'),
    const KakaoChurchResult(id: '161', name: '나주교회', address: '전남 나주시 송월동', roadAddress: '전남 나주시 금계로 56'),
    const KakaoChurchResult(id: '162', name: '해남교회', address: '전남 해남군 해남읍', roadAddress: '전남 해남군 해남읍 중앙2로 35'),
    // 경상도 추가
    const KakaoChurchResult(id: '163', name: '구미교회', address: '경북 구미시 원평동', roadAddress: '경북 구미시 송원동로 12'),
    const KakaoChurchResult(id: '164', name: '김천교회', address: '경북 김천시 남산동', roadAddress: '경북 김천시 자산로 52'),
    const KakaoChurchResult(id: '165', name: '영주교회', address: '경북 영주시 영주동', roadAddress: '경북 영주시 광복로 76'),
    const KakaoChurchResult(id: '166', name: '상주교회', address: '경북 상주시 남성동', roadAddress: '경북 상주시 왕산로 226'),
    const KakaoChurchResult(id: '167', name: '통영교회', address: '경남 통영시 무전동', roadAddress: '경남 통영시 중앙로 257'),
    const KakaoChurchResult(id: '168', name: '사천교회', address: '경남 사천시 동금동', roadAddress: '경남 사천시 사천읍 충무공로 27'),
    const KakaoChurchResult(id: '169', name: '양산교회', address: '경남 양산시 중부동', roadAddress: '경남 양산시 중부로 10'),
    const KakaoChurchResult(id: '170', name: '밀양교회', address: '경남 밀양시 내일동', roadAddress: '경남 밀양시 중앙로 299'),
    // 강원도 추가
    const KakaoChurchResult(id: '171', name: '동해교회', address: '강원 동해시 천곡동', roadAddress: '강원 동해시 천곡로 50'),
    const KakaoChurchResult(id: '172', name: '삼척교회', address: '강원 삼척시 남양동', roadAddress: '강원 삼척시 중앙로 2'),
    const KakaoChurchResult(id: '173', name: '태백교회', address: '강원 태백시 황지동', roadAddress: '강원 태백시 태백로 84'),
    const KakaoChurchResult(id: '174', name: '횡성교회', address: '강원 횡성군 횡성읍', roadAddress: '강원 횡성군 횡성읍 태기로 16'),
    const KakaoChurchResult(id: '175', name: '양양교회', address: '강원 양양군 양양읍', roadAddress: '강원 양양군 양양읍 남문로 44'),
    // 유명 대형교회 추가
    const KakaoChurchResult(id: '176', name: '우리들교회', address: '서울 강남구 역삼동', roadAddress: '서울 강남구 테헤란로 325'),
    const KakaoChurchResult(id: '177', name: '높은뜻숭의교회', address: '서울 강남구 일원동', roadAddress: '서울 강남구 일원로 21'),
    const KakaoChurchResult(id: '178', name: '높은뜻하나교회', address: '경기 용인시 수지구', roadAddress: '경기 용인시 수지구 동천로 535'),
    const KakaoChurchResult(id: '179', name: '두레교회', address: '경기 성남시 중원구', roadAddress: '경기 성남시 중원구 둔촌대로 484'),
    const KakaoChurchResult(id: '180', name: '갈보리교회', address: '서울 중구 충무로', roadAddress: '서울 중구 퇴계로 200'),
    const KakaoChurchResult(id: '181', name: '동산교회', address: '서울 성동구 옥수동', roadAddress: '서울 성동구 독서당로 85'),
    const KakaoChurchResult(id: '182', name: '대한교회', address: '서울 서초구 양재동', roadAddress: '서울 서초구 바우뫼로 27'),
    const KakaoChurchResult(id: '183', name: '성민교회', address: '서울 구로구 고척동', roadAddress: '서울 구로구 경서로 3'),
    const KakaoChurchResult(id: '184', name: '향상교회', address: '서울 송파구 석촌동', roadAddress: '서울 송파구 백제고분로 45길 14'),
    const KakaoChurchResult(id: '185', name: '새빛교회', address: '서울 노원구 공릉동', roadAddress: '서울 노원구 공릉로 232'),
    const KakaoChurchResult(id: '186', name: '수원제일교회', address: '경기 수원시 장안구', roadAddress: '경기 수원시 장안구 정조로 883'),
    const KakaoChurchResult(id: '187', name: '번동교회', address: '서울 강북구 번동', roadAddress: '서울 강북구 한천로 140길 5'),
    const KakaoChurchResult(id: '188', name: '거룩한빛교회', address: '서울 강남구 수서동', roadAddress: '서울 강남구 광평로 280'),
    const KakaoChurchResult(id: '189', name: '세움교회', address: '서울 마포구 서교동', roadAddress: '서울 마포구 와우산로 94'),
    const KakaoChurchResult(id: '190', name: '한성교회', address: '서울 종로구 명륜동', roadAddress: '서울 종로구 성균관로 26'),
    const KakaoChurchResult(id: '191', name: '백석교회', address: '경기 고양시 일산동구 백석동', roadAddress: '경기 고양시 일산동구 중앙로 1036'),
    const KakaoChurchResult(id: '192', name: '세계로교회', address: '경기 부천시 원미구 중동', roadAddress: '경기 부천시 원미구 길주로 1'),
    const KakaoChurchResult(id: '193', name: '산성교회', address: '경기 성남시 수정구 신흥동', roadAddress: '경기 성남시 수정구 수정로 171'),
    const KakaoChurchResult(id: '194', name: '남양주중앙교회', address: '경기 남양주시 다산동', roadAddress: '경기 남양주시 다산중앙로 82'),
    const KakaoChurchResult(id: '195', name: '세교교회', address: '경기 화성시 세교동', roadAddress: '경기 화성시 세교중앙로 50'),
    const KakaoChurchResult(id: '196', name: '광명중앙교회', address: '경기 광명시 철산동', roadAddress: '경기 광명시 철산로 22'),
    const KakaoChurchResult(id: '197', name: '소사교회', address: '경기 부천시 소사구', roadAddress: '경기 부천시 소사구 경인로 170'),
    const KakaoChurchResult(id: '198', name: '덕소교회', address: '경기 남양주시 와부읍', roadAddress: '경기 남양주시 와부읍 덕소로 85'),
    const KakaoChurchResult(id: '199', name: '세마교회', address: '경기 오산시 세마동', roadAddress: '경기 오산시 세마역로 20'),
    const KakaoChurchResult(id: '200', name: '조안교회', address: '경기 남양주시 조안면', roadAddress: '경기 남양주시 조안면 다산로 541'),
  ];
}
