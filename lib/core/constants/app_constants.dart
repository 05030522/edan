...
class AppConstants {
  ...
  static const List<String> streakBreakComforts = [
    '괜찮아요~ 하나님의 은혜는 매일 새로워요.\n다시 함께 걸어요!',
    '쉬어가는 것도 여정의 일부예요.\n에덴은 항상 여기서 기다리고 있어요~',
    '다시 돌아온 것 자체가 정말 대단해요!\n오늘부터 새롭게 시작해요~',
    '넘어져도 다시 일어서는 마음이\n가장 아름다운 믿음이에요!',
  ];
  ...
  static const List<Map<String, dynamic>> dailyQuests = [
    {'title': '오늘의 묵상 완료하기', 'reward': 10, 'type': 'lesson_complete'},
    {'title': '셀라 묵상 기록 남기기', 'reward': 5, 'type': 'selah_record'},
    {'title': '한 줄 기도 적기', 'reward': 5, 'type': 'prayer_record'},
  ];
}
